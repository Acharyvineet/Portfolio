...
function populateUI() {
  ...
  const selectedClassIndex = localStorage.getItem('selectedClassIndex');

  if (selectedClassIndex !== null) {
    ClassSelect.selectedIndex = selectedClassIndex;
  }
}
